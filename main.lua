...
Tabs.Combat:CreateDropdown({ Name = "Parry Mode", Options = {"Hold", "Toggle", "Trigger"}, CurrentOption = {Config.AutoParryMode}, Flag = "AutoParryMode", Callback = function(o) Config.AutoParryMode = type(o)=="table" and o[1] or o end })
Tabs.Combat:CreateDropdown({ Name = "Detection Method", Options = {"Animation", "Sound", "Both"}, CurrentOption = {Config.AutoParryDetection}, Flag = "AutoParryDetect", Callback = function(o) Config.AutoParryDetection = type(o)=="table" and o[1] or o end })
...
Tabs.Combat:CreateDropdown({ Name = "Anti Parry Mode", Options = {"Hold", "Toggle"}, CurrentOption = {Config.AntiParryMode}, Flag = "AntiParryMode", Callback = function(o) Config.AntiParryMode = type(o)=="table" and o[1] or o end })
...
Tabs.Combat:CreateDropdown({ Name = "Target Part", Options = {"Head", "Torso", "HumanoidRootPart", "Arms", "Legs"}, CurrentOption = {Config.HitboxTarget}, Flag = "HitboxTargetOpt", Callback = function(o) Config.HitboxTarget = type(o)=="table" and o[1] or o end })
...
Tabs.Combat:CreateDropdown({ Name = "Color Mode", Options = {"Static", "Rainbow"}, CurrentOption = {Config.HitboxColorMode}, Flag = "HitboxColMode", Callback = function(o) Config.HitboxColorMode = type(o)=="table" and o[1] or o end })
...
Tabs.Aimbot:CreateDropdown({ Name = "Aimbot Mode", Options = {"Hold", "Toggle", "Trigger"}, CurrentOption = {Config.AimbotMode}, Flag = "AimMode", Callback = function(o) Config.AimbotMode = type(o)=="table" and o[1] or o end })
...
Tabs.Aimbot:CreateDropdown({ Name = "Aim Method", Options = {"Camera", "Mouse"}, CurrentOption = {Config.AimbotMethod}, Flag = "AimMethod", Callback = function(o) Config.AimbotMethod = type(o)=="table" and o[1] or o end })
...
Tabs.Visuals:CreateDropdown({ Name = "ESP Mode", Options = {"Hold", "Toggle"}, CurrentOption = {Config.ESPMode}, Flag = "ESPMode", Callback = function(o) Config.ESPMode = type(o)=="table" and o[1] or o end })
