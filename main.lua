...
pcall(function() Tabs.Combat:CreateDropdown({ Name = "Target Part", Options = {"Head", "Torso", "HumanoidRootPart", "Arms", "Legs"}, Flag = "HitboxTargetOpt", Callback = function(o) Config.HitboxTarget = type(o)=="table" and o[1] or o end }) end)
...
pcall(function() Tabs.Combat:CreateDropdown({ Name = "Color Mode", Options = {"Static", "Rainbow"}, Flag = "HitboxColMode", Callback = function(o) Config.HitboxColorMode = type(o)=="table" and o[1] or o end }) end)
...
pcall(function() Tabs.Aimbot:CreateDropdown({ Name = "Aimbot Mode", Options = {"Hold", "Toggle", "Trigger"}, Flag = "AimMode", Callback = function(o) Config.AimbotMode = type(o)=="table" and o[1] or o end }) end)
...
pcall(function() Tabs.Aimbot:CreateDropdown({ Name = "Aim Method", Options = {"Camera", "Mouse"}, Flag = "AimMethod", Callback = function(o) Config.AimbotMethod = type(o)=="table" and o[1] or o end }) end)
...
pcall(function() Tabs.Visuals:CreateDropdown({ Name = "ESP Mode", Options = {"Hold", "Toggle"}, Flag = "ESPMode", Callback = function(o) Config.ESPMode = type(o)=="table" and o[1] or o end }) end)
...
pcall(function() Tabs.Visuals:CreateDropdown({ Name = "Color Mode", Options = {"Static", "Rainbow"}, Flag = "ESPColMode", Callback = function(o) Config.ESPColorMode = type(o)=="table" and o[1] or o end }) end)
